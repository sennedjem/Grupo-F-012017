...
public class MarketingManager extends User {
	...
	public void createOfferByCategory(Integer id, LocalDate start, LocalDate end, int discount,
			                          Category category){
				this.getManagement().addOffer(new ByCategory(id, start, end, discount, category));
	}
	
	public void createOfferByCombination(Integer id, LocalDate start, LocalDate end, int discount,
										 Product product1, Product product2){
				this.getManagement().addOffer(new ByCombination(id, start, end, discount, product1, product2));
	}
	
	public void createOfferByProduct(Integer id, LocalDate start, LocalDate end, int discount,
                                     Product product){
